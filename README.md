...
I'm a biochemist and product builder working at the intersection of **molecular science, AI, and human health**. My current focus is translating complex physiological data into actionable, personalized health experiences — using LLMs, phenotypic profiling, and a deep curiosity for how biological systems work.
...
- 🧬 **M.Sc. research** at the Weizmann Institute of Science
- 🤖 **AI-powered fitness coaching** at Amp — personalizing health interventions via LLMs and phenotypic data
- 📊 Deep interest in **Data-Driven Biology**, the **Human Microbiome**, and **Gene Expression** analysis for precision wellness
